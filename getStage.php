                    ...
                    If ($type == 'Etapa') {
                        ...
                        if ($stage == 1) {
                            $sql = "SELECT Atleta.id AS idAtleta, Atleta.Nome, Etapa_$stage.Posição_Etapa_$stage,
                                    SEC_TO_TIME(SUM(TIME_TO_SEC(Etapa_1.Tempo))) AS TempoTotal
                                    FROM Atleta
                            ...
                            $sql = "SELECT Atleta.id AS idAtleta, Atleta.Nome, Etapa_$stage.Posição_Etapa_$stage,
                                    SEC_TO_TIME(SUM(TIME_TO_SEC(Etapa_1.Tempo) + TIME_TO_SEC(Etapa_2.Tempo))) AS TempoTotal
                                    FROM Atleta
                                    LEFT JOIN Etapa_1 ON Atleta.id = Etapa_1.idAtleta
                            ...
                            $sql = "SELECT Etapa_$stage.Posição_Etapa_$stage, Atleta.Nome, Atleta.id AS idAtleta, Etapa_$stage.Tempo 
                                    ...
                                    JOIN Atleta ON Etapa_$stage.idAtleta = Atleta.id";
                            $sql = "SELECT Atleta.id AS idAtleta, Atleta.Nome, Etapa_$stage.Posição_Etapa_$stage ,
                                    SEC_TO_TIME(SUM(TIME_TO_SEC(Etapa_1.Tempo) + TIME_TO_SEC(Etapa_2.Tempo) + TIME_TO_SEC(Etapa_3.Tempo))) AS TempoTotal 
                                    FROM Atleta
                                    LEFT JOIN Etapa_1 ON Atleta.id = Etapa_1.idAtleta
                                    LEFT JOIN Etapa_2 ON Atleta.id = Etapa_2.idAtleta
                            ...
                            $sql = "SELECT Etapa_$stage.Posição_Etapa_$stage, Atleta.Nome, Atleta.id AS idAtleta, Etapa_$stage.Tempo 
                                    ...
                                    JOIN Atleta ON Etapa_$stage.idAtleta = Atleta.id";
                            $sql = "SELECT Atleta.id AS idAtleta, Atleta.Nome, Etapa_$stage.Posição_Etapa_$stage,
                                    SEC_TO_TIME(SUM(TIME_TO_SEC(Etapa_1.Tempo) + TIME_TO_SEC(Etapa_2.Tempo) + TIME_TO_SEC(Etapa_3.Tempo) + TIME_TO_SEC(Etapa_4.Tempo))) AS TempoTotal 
                                    FROM Atleta
                                    LEFT JOIN Etapa_1 ON Atleta.id = Etapa_1.idAtleta
                                    LEFT JOIN Etapa_2 ON Atleta.id = Etapa_2.idAtleta
                                    LEFT JOIN Etapa_3 ON Atleta.id = Etapa_3.idAtleta
                            ...
                            $sql = "SELECT Etapa_$stage.Posição_Etapa_$stage, Atleta.Nome, Atleta.id AS idAtleta, Etapa_$stage.Tempo 
                                    ...
                                    JOIN Atleta ON Etapa_$stage.idAtleta = Atleta.id";
                            $sql = "SELECT Atleta.id AS idAtleta, Atleta.Nome, Etapa_$stage.Posição_Etapa_$stage,
                                    SEC_TO_TIME(SUM(TIME_TO_SEC(Etapa_1.Tempo) + TIME_TO_SEC(Etapa_2.Tempo) + TIME_TO_SEC(Etapa_3.Tempo) + TIME_TO_SEC(Etapa_4.Tempo) + TIME_TO_SEC(Etapa_5.Tempo))) AS TempoTotal 
                                    FROM Atleta
                                    LEFT JOIN Etapa_1 ON Atleta.id = Etapa_1.idAtleta
                                    LEFT JOIN Etapa_2 ON Atleta.id = Etapa_2.idAtleta
                                    LEFT JOIN Etapa_3 ON Atleta.id = Etapa_3.idAtleta
