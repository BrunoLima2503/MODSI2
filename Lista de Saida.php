...
<div class="Section20" style="width: 360px; height: 800px; background: #032383; position: relative;">
    ...
    <div id="arrowCircle" class="ArrowCircle" style="width: 34px; height: 34px; left: 13px; top: 11px; position: absolute; background: black; border-radius: 9999px"></div>
        <img class="ArrowVector2" style="width: 20px; height: 12px; left: 40px; top: 34px; position: absolute; transform: rotate(-180deg); transform-origin: 0 0" src="Fotos/Arrow Vector 0.png" />
    </div>
